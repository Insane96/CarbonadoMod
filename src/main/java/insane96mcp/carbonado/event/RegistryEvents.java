...
public class RegistryEvents {
	...
	public static void onRegisterItems(final RegistryEvent.Register<Item> itemRegistryEvent) {
		...
		itemRegistryEvent.getRegistry().registerAll(
				...
				new AxeItem(ModMaterial.TOOLS_CARBONADO, 10f, -30.f, new Item.Properties().group(ItemGroup.TOOLS)).setRegistryName(Carbonado.MOD_ID, Strings.Names.CARBONADO_AXE),
